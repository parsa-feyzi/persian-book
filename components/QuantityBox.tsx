...
function QuantityBox({ initialCount }: I_Props) {
  ...
  return (
    <div className="flex items-center justify-between w-20 p-1  rounded-lg text-(--prim) pry_border">
      <div onClick={handleIncrease} className={count === 20 ? "opacity-40" : "cursor-pointer active:scale-90"}>
      ...
      {count === 1 ? (
        <div
          ...
          className="cursor-pointer text-(--seco)/50 hover:text-red-700/70 active:scale-90"
        >
