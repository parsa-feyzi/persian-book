    ...
    <div className="bg-white border border-(--seco)/20 rounded-xl  overflow-hidden">
      <div className="bg-(--base)">
        <Link href={"/product/1"} className="py-4 w-fit mx-auto block">
          <img
            className="max-h-44 sm:h-auto h-34 shadow-lg/5 object-cover rounded-xl"
      ...
      <div className="sm:p-4 p-2 pt-2 pb-2">
        <Link href={"/product/1"} className="font-[dana-b] block sm:text-lg">
          عادت های اتمی
        </Link>
        <div className="flex pt-2 justify-between items-center">
          ...
          <div>
            <div className="flex justify-between gap-1 items-center">
              ...
              <div className="discount text-sm!">{(250000).toLocaleString()}</div>
            </div>
            <div className="price text-lg">
              {(250000).toLocaleString()}
              <span className="text-xs font-[dana-l] font-light ps-0.5 text-(--seco)">
                تومان
              </span>
            </div>
          </div>
