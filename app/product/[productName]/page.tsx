...
import ProductImagesBoxInDesktop from "./components/ProductImagesBoxInDesktop";
import ProductImagesBoxInMobail from "./components/ProductImagesBoxInMobail";
import LinkToContent from "./components/LinkToContent";

function Product() {
  return (
    <div className="p-nav relative">
      {/* <div className="h-12 bg-white/80 rounded-2xl my-8"></div> */}
      <ProductImagesBoxInMobail src="Atomic-Habits.webp" />
                ...
                <div className="lg:col-span-8 col-span-12  lg:ms-6 ms-0 flex flex-col justify-between gap-4 py-2">
                  <div>
                    ...
                    >
                      ...
                      <LinkToContent href="aiSummaryOpinion" lable="دیدگاه" number={242} />
                      <LinkToContent href="question" lable="پرسش" number={32} />
                    </div>
